 ...
 */
const ManuscriptViewAction = ({ id }: { id: number }) => {
  ...
  return (
    <div className="flex justify-center">
      <Button
        ...
        title="View Document"
        onClick={() =>
          router.push(`/front-pages/manuscripts/${id}?from=${encodeURIComponent(currentPath)}`)
        }
      >
        <Eye />
      </Button>
...
const columns: ColumnDef<TDocumentOut>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex justify-center">
          <ManuscriptViewAction id={document.id} />
        </div>
      )
    },
  },
...
export default function ManuscriptDocumentsTable({
  filterParams = {},
}: DocumentsTableProps) {
