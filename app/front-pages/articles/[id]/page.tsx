...
import ArticleImagesCard from "./components/ArticleImagesCard"
...
const ArticleDocumentDisplay = (props: DocumentDisplayProps) => {
          ...
          <div className="p-4 sm:p-6 md:p-8">
            ...
            <TabsContent value="images" className="mt-0">
              <div className="max-w-5xl mx-auto">
                {document && <ArticleImagesCard document_id={document.id} subject_id={document.subject_id} />}
              </div>
            </TabsContent>
          </div>
        </Tabs>
...
export default ArticleDocumentDisplay
