 ...
 */
const ArticleViewAction = ({ id }: { id: number }) => {
  ...
  return (
    <div className="flex justify-center">
      <Button
        ...
        title="View Document"
        onClick={() =>
          router.push(`/front-pages/articles/${id}?from=${encodeURIComponent(currentPath)}`)
        }
      >
        <Eye />
      </Button>
...
const columns: ColumnDef<TDocumentOut>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex justify-center">
          <ArticleViewAction id={document.id} />
        </div>
      )
    },
  },
...
export default function ArticleDocumentsTable({
  filterParams = {},
}: DocumentsTableProps) {
