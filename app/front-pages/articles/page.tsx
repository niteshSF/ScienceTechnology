...
import ArticleDocumentsTable from "./components/ArticleDocumentTable"
...
const Articles = () => {
  ...
  useEffect(() => {
    if (subjectId) {
      ...
      form.setValue("document_type", "article")
      setFilterParams({
          ...
          {selectedSubject ? (
            <div className="max-w-7xl mx-auto space-y-6">
              <DocumentsTableWrapper ref={documentsTableRef}>
                <ArticleDocumentsTable filterParams={filterParams} />
