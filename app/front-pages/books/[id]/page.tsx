...
import BookImagesCard from "./components/BookImagesCard"
...
const BookDocumentDisplay = (props: DocumentDisplayProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="pt-[110px] w-full max-w-7xl mx-auto rounded-lg overflow-hidden pb-8">
...
export default BookDocumentDisplay
