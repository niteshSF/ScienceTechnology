...
// type PageProps = {
//   searchParams: Promise<{ doc_id: string; file_id: string }>
// }

// // Updated component for Next.js 15
// export default function ImageDisplay(props: PageProps) {
//   // Using Next.js 15 data fetching pattern
//   const searchParams = use(props.searchParams)
//   const router = useRouter()

//   // Parse query parameters
//   const document_id = parseInt(searchParams.doc_id || "1", 10)
//   const file_id = parseInt(searchParams.file_id || "1", 10)
...
//   // Data fetching with the existing hook
...
// const returnTo = searchParam.get("return_to")
...
//                 priority={idx < 9} // Load first 9 images with priority
//               />
...
export default function ImageDisplay() {
  ...
  const handleBack = () => {
    if (returnTo) {
      router.push(`/documents/${document_id}?from=%2Fdocuments%3F&tab=images`)
    } else {
      router.push(`/documents/${document_id}?tab=images`)
    }
  }
