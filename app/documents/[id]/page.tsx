...
// import DocumentNameCard from "./components/DocumentNameCard"
// import { useGetDocumentQuery } from "@/api/documents.api"
// import MetadataCard from "./components/MetadataCard"
// import { FileText, Image as ImageIcon } from "lucide-react"
// import DescriptionCard from "./components/DescriptionCard"
// import AdditionalCard from "./components/AdditionCard"
// import SourceCard from "./components/SourceCard"
// import PublicationCard from "./components/PublicationCard"
// import ImagesCard from "./components/ImagesCard"
// import { useRouter, useSearchParams } from "next/navigation"
// import { use } from "react"
// import NMMDetailsCard from "./components/NMMDetailsCard"
...
//   const from = searchParam.get("from") || "/front-pages/books"

//   // Get tab from query params, default to "document" if not provided
...
//   return (
//     <div className="w-full max-w-7xl mx-auto rounded-lg overflow-hidden py-4">
//       {document?.name_in_diacritical && (
//         <div className="flex items-center justify-between mb-1">
//           <button
//             // onClick={() => router.back()}
//             onClick={() => router.push(from)}
//             className="bg-red-900 text-white px-6 py-1.5 rounded"
//           >
//             Back
//           </button>

//           <h2 className="text-center text-3xl font-bold underline mb-4 text-primary">
//             {document.name_in_diacritical}
//           </h2>
...
//               {document && <ImagesCard document_id={document.id} />}
//             </div>
//           </TabsContent>
//         </div>
//       </Tabs>
              ...
              <TabsContent value="document" className="mt-0">
                {document && (
                  <div className="space-y-8 max-w-5xl mx-auto">
                    ...
                    <AuthorCard id={document.author_id} />
                    {document.scribe_id && (
                      <ScribeCard id={document.scribe_id} />
                    )}
                    <NMMDetailsCard document_id={document.id} />
                    <SourceCard document_id={document.id} />
                    <PublicationCard document_id={document.id} />
